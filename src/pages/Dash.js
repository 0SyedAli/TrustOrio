...
export default function VerticalTabs() {
    ...
    return (
        <Box
            sx={{  flexGrow: 1, bgColor: 'background.paper', display: 'flex', height: 450, mt: 5 }}
        >
            <Tabs
            ...
            >
                ...
                <Tab sx={{
                    ...
                    marginTop: 0,
                    borderRadius: 1,
                    '& button:hover': { backgroundColor: '#d5aa6d' }
                }} label="Lawyer" {...a11yProps(1)} />
                ...
                <Tab sx={{
                    ...
                    marginTop: 0,
                    borderRadius: 1
                }} label="Profile Update" {...a11yProps(2)} />
                ...
                <Tab sx={{
                    ...
                    marginTop: 0,
                    borderRadius: 1
                }} label="Payment History" {...a11yProps(3)} />
...
<div className="profile myProf">
    ...
    <div className="update-profile">
        ...
        <div className="name2 update-">
            ...
            <TabPanel value={value} index={4} element={<Home />}>
